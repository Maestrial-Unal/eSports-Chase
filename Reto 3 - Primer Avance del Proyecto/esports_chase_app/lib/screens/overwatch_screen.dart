...
class OverwatchScreen extends StatelessWidget {
  const OverwatchScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return const Expanded(
      child: TabBarView(
        ...
        children: [
          NewsTab(imageURL: "static/assets/B_Overwatch.jpg", tabName: "Overwatch"),
          TournamentsTab(),
          LiveTab(),
        ],
      ),
